<template>
	<div class="card mb-3">
		<div class="card-body">
			...
			<a href="">
				<svg xmlns="http://www.w3.org/2000/svg" :width="icon_width+'px'" :height="icon_hegiht+'px'" fill="currentColor" class="bi bi-bookmark float-right book_mark_logo" viewBox="0 0 16 16" v-if="!is_book_marked">
				...
				<svg xmlns="http://www.w3.org/2000/svg"  :width="icon_width+'px'" :height="icon_hegiht+'px'" fill="currentColor" class="bi bi-bookmark float-right book_mark_logo" viewBox="0 0 16 16"   v-if="is_book_marked">
				<path d="M2 2v13.5a.5.5 0 0 0 .74.439L8 13.069l5.26 2.87A.5.5 0 0 0 14 15.5V2a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2z"  v-if="is_book_marked"/>
				</svg>
			</a>
			<br><br>
			...
			<svg xmlns="http://www.w3.org/2000/svg" :width="icon_width +'px'" :height="icon_hegiht+ 'px'" fill="currentColor" class="bi bi-heart-fill float-left" viewBox="0 0 16 16" v-if="is_liked">
			<path fill-rule="evenodd" d="M8 1.314C12.438-3.248 23.534 4.735 8 15-7.534 4.736 3.562-3.248 8 1.314z"/>
			</svg>
			</a>
			<span class="card-text float-left icon_text">5</span>
			<span class=" float-right icon_text" >3</span>
			<a href="">
